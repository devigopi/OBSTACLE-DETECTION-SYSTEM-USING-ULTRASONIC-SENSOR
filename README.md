...
Aim: To design and simulate a distance measurement system using an ultrasonic sensor HC-SR04 interfaced with an Arduino Uno board in Tinkercad.

Hardware / Software Tools required:

Arduino Uno R3 HC-SR04 Ultrasonic Distance Sensor Jumper Wires USB Cable (for simulation purpose in Tinkercad)
...
<img width="833" height="510" alt="image" src="https://github.com/user-attachments/assets/50fee2aa-f484-40ae-b318-a146357998bf" />
...
Result
Result
Result: The simulation successfully measured the distance between the ultrasonic sensor HC-SR04 and the object. The real-time distance values were accurately displayed on the serial monitor in centimeters.
